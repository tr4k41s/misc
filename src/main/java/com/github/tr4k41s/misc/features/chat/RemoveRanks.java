...
public class RemoveRanks {
    ...
    static {
        ...
        removeText.add(Pattern.compile("Crypt Wither Skull exploded,"));
        removeText.add(Pattern.compile("struck you for"));
        removeText.add(Pattern.compile("Queuing\\.\\.\\."));
        removeText.add(Pattern.compile("using this class!"));
        ...
        removeText.add(Pattern.compile("You (sold|bought back) .+ x\\d for [\\d,.]+ Coin(s)?!"));
        ...
        removeText.add(Pattern.compile("Creeper Veil (De-)?Activated!"));
